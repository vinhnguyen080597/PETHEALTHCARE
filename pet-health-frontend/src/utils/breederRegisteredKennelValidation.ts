import { REGISTRATION_UNIT_OTHER } from './breederRegistrationUnits.ts';
...
export function hasRegisteredKennelFieldErrors(errors: RegisteredKennelFieldErrors): boolean {
