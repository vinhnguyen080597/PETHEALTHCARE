    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Seller legal verification: Sellers who complete the Household business / Enterprise verification flow submit business registration documents and tax IDs for admin review. After approval, the marketplace may display a public entity-type tag (Household business or Enterprise). Tax ID / registration numbers are not shown on public listings. Document review supports platform transparency and does not certify veterinary hygiene, breeding permits, wildlife legality, or full tax compliance of the Seller.",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Xác minh pháp lý Người bán: Người bán hoàn tất luồng xác minh Hộ kinh doanh / Doanh nghiệp sẽ nộp giấy tờ đăng ký kinh doanh và MST để admin rà soát. Sau khi duyệt, Sàn có thể hiển thị tag loại hình công khai (Hộ kinh doanh hoặc Doanh nghiệp). Số MST/ĐKKD không được công bố trên gian hàng. Việc rà soát giấy tờ phục vụ minh bạch trên Sàn, không chứng nhận điều kiện vệ sinh thú y, giấy phép chăn nuôi, tính hợp pháp nguồn gốc động vật hay toàn bộ nghĩa vụ thuế của Người bán.",
        ],
      },
      {
