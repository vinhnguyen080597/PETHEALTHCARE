...
const COMPLIANCE_BAND_CHIP_CLASSES: Record<ComplianceBandId, string> = {
...
export function complianceBandChipClass(band: ComplianceBandId): string {
  return COMPLIANCE_BAND_CHIP_CLASSES[band];
}
