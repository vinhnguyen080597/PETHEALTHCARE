...
export function MarketplaceSearchBar({
  ...
  const selectCls =
    "w-full px-3 py-2.5 bg-[#FDFBF7] border border-[#F0E6D8] rounded-xl text-sm text-[#2B1E19] focus:outline-none focus:ring-2 focus:ring-amber-500/25 focus:border-[#D97706]";
