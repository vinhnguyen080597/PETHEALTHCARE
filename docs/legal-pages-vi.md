# PetCare: Pet Marketplace — Quy chế hoạt động & Chính sách pháp lý (Tiếng Việt)

> Đồng bộ với `/privacy-policy`, `/terms-of-service`, `/marketplace-guidelines`, `/support`.
> Cập nhật lần cuối: **tháng 8/2026**.
> Pháp lý: **contact@pet-marketplace.org** · Hỗ trợ: **support@pet-marketplace.org**

---

## Mục lục

1. [Chính sách bảo mật](#1-chính-sách-bảo-mật)
2. [Điều khoản dịch vụ](#2-điều-khoản-dịch-vụ)
3. [Nội quy Marketplace](#3-nội-quy-marketplace)
4. [Hỗ trợ](#4-hỗ-trợ)
...
- Đơn vị vận hành: CÔNG TY TNHH PETCARE VIỆT NAM (đang trong quá trình hoàn tất thủ tục ĐKKD).
...
- Email liên hệ / pháp lý: contact@pet-marketplace.org.
...
- Quyền yêu cầu xóa dữ liệu / xóa tài khoản: người dùng có quyền yêu cầu hủy tài khoản và xóa toàn bộ dữ liệu cá nhân bất kỳ lúc nào bằng cách thao tác tại Cài đặt > Xóa tài khoản trên ứng dụng, hoặc gửi email đến contact@pet-marketplace.org.
...
Thắc mắc về bảo mật: contact@pet-marketplace.org
...
### Vai trò của PetCare: Pet Marketplace
...
### Cơ chế kiểm duyệt & gỡ bỏ tin vi phạm trong 24 giờ
...
Thắc mắc về Điều khoản: contact@pet-marketplace.org

---

## 3. Nội quy Marketplace
...
### Quy trình 4 bước bàn giao & giải ngân cọc
...
- Khi phát sinh tranh chấp liên quan lừa đảo tiền cọc, bé cưng bị bệnh truyền nhiễm ngay tại thời điểm nhận, hoặc Người bán không thực hiện đúng bảo hành: bấm “Báo cáo” trên app hoặc gửi email tới support@pet-marketplace.org kèm bằng chứng (ảnh chat, video bàn giao, sổ tiêm/giấy khám từ bác sĩ thú y).
...
### Thông tin hỗ trợ & tiếp nhận phản ánh

- Email hỗ trợ khách hàng: support@pet-marketplace.org
- Email tiếp nhận pháp lý & báo cáo: contact@pet-marketplace.org
...
| Nội quy Marketplace | `/marketplace-guidelines` |
| Hỗ trợ | `/support` |
