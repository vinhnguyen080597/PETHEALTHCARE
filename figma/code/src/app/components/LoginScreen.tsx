  ...
  return (
    <div className="h-full flex flex-col bg-gradient-to-b from-blue-600 to-blue-700">
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        <div className="size-24 bg-white rounded-full flex items-center justify-center mb-6 shadow-lg">
          <Stethoscope className="size-12 text-blue-600" />
        </div>
        <h1 className="text-3xl text-white mb-2">Catties Health Care</h1>
        ...
        <div className="w-full max-w-sm bg-white rounded-2xl shadow-2xl p-6">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-black text-white rounded-xl hover:bg-gray-900 transition-colors"
            >
      ...
      <div className="px-6 py-4 text-center text-blue-100 text-xs">
