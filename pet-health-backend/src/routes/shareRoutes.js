...
function renderShareHtml({ postId, card, canonicalUrl, appUrl }) {
  const title = card?.title || 'Pethub: Pet Marketplace';
  const description = card?.description
    || 'Xem tin đăng thú cưng và mở bằng ứng dụng Pethub: Pet Marketplace.';
...
<html lang="vi">
  <head>
    ...
    <title>${escapeHtml(title)} · Pethub: Pet Marketplace</title>
    <meta name="description" content="${escapeHtml(description)}" />
    <link rel="canonical" href="${escapeHtml(canonicalUrl)}" />

    <meta property="og:type" content="website" />
    <meta property="og:site_name" content="Pethub: Pet Marketplace" />
  ...
  <body>
    <main>
      <p class="eyebrow">Pethub: Pet Marketplace</p>
      <section class="card">
        <div class="media">
        ...
        <div class="body">
          ...
          <p class="meta">${escapeHtml(found ? description : 'Tin này có thể đã bị gỡ hoặc chưa được duyệt. Tải ứng dụng để xem các tin khác trên Pethub: Pet Marketplace.')}</p>
          <div class="actions">
